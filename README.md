...
- test - please use Pester - tests for translations are taged as 'Translations', you can also uncomment line in the Format-Pester.ps1 file (remember about re-import module with Force)
```
#$LocalizedStrings
```
